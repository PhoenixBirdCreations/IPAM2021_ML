...
if __name__ == '__main__':
    ...
    ax[0,0].plot(ytest[:,0], predicted_data[:,0], 'o', markersize=2, color=color_cycle[6], zorder=-2, label='Regressed')   
    ...
    ax[0,1].plot(ytest[:,1], predicted_data[:,1], 'o', markersize=2, color=color_cycle[6], zorder=-2)   
    ...
    ax[1,0].plot(ytest[:,2], xtest[:,2], 'o', markersize=2, color=color_cycle[9], zorder=-3)
    ax[1,0].plot(ytest[:,2], predicted_data[:,2], 'o', markersize=2, color=color_cycle[6], zorder=-2)
    ...
    ax[1,1].plot(ytest[:,3], xtest[:,3], 'o', markersize=2, color=color_cycle[9], zorder=-3)
    ax[1,1].plot(ytest[:,3], predicted_data[:,3], 'o', markersize=2, color=color_cycle[6], zorder=-2)
