...
\section{Is the $q$-distribution in the injected data a problem?}
\label{sec:epochs_quniform}
%
\begin{figure*}[]
  \center
  \includegraphics[width=0.98\textwidth]{./Figs/quniform_histo_inj.png}
  \rule[1ex]{14cm}{0.5pt}\\
  \includegraphics[width=0.98\textwidth]{./Figs/quniform_histo_rec.png}
