...
%==========================================================
\section{Loss function, attempt 1}
%==========================================================
\label{sec:loss}
...
\begin{equation}
J_{\rm mse} = {\rm mean} \sum_i \left( y_i - \hat{y}_i \right)^2 \cdot(1+\lambda(\mathcal{M}_c-\hat{\mathcal{M}}_c)^2)\cdot \rm{SNR}
\end{equation}
...
UPDATE: added square in the $\Mc$ difference.
...
nothing new except the very elegant choice of colors for injected (black), recovered (grey),
...
However, considering Sec.~\ref{sec:GstLALanalysis}, it could be that
the mean errors are not very significant. 
