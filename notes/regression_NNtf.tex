...
\end{equation} 
is not enforced during the training (i.e. the predictions for $p_k$ and $M_c$ are independent), 
...
\end{equation}
where $i\neq j=1,2$, explicitely (omitting the superscript 'pred' in the RHSs):
\begin{align}
...
problem). Probably this is linked to the strong degeneracy in the recovery of the masses, 
