...
chosen as a two-dimensional vector space ${\bf A}_{{\bf X}'}\subset \mathbb{R}^n$. This scheme allows the calculation of Eqs.~\eqref{bayes-hasns} and \eqref{bayes-hasrem} with a single
...
events in $D_S$ that are correctly and incorrectly classified as ${\hasns_+}$ by the outcome $f_1+f_2$, respectively. The first factor in the right-hand side of Eq. ~\eqref{bayes-hasrem}
