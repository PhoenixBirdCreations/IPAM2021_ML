...
maximum mass of $2.05 M_\odot$ and is the standard \ac{EOS} used in \ac{LVK} low-latency investigations~\cite{Chaudhary:2023vec} \mmt{[MMT:https://arxiv.org/pdf/2104.08681.pdf Link to Shaon's Paper]}. The markers denote different thresholds for the Bayesian
