...
probabilities defined in the Section~\nameref{bayesian_probs}, in terms of the output of the algorithms (fractions of neighbors and fractions of trees, respectively). In order to obtain the probabilities given in Equations~\ref{bayes-hasns} and~\ref{bayes-hasrem} one needs to apply the algorithm on known events \mmt{[MMT: applied on O2, right?]}. 
...
performed as explained in the Section~\nameref{bayesian_probs}. In this figures we show
...
As stated in the Section~\nameref{bayesian_probs}, the fits of the probabilities
