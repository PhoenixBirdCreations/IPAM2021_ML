...
\hasns\ and \hasrem\ probability estimators for \ac{KNN} and \ac{RF} and each of the 23 \ac{EOS} are shown in Fig.~\ref{fig:bayesian_prob_fits_KNN} and~\ref{fig:bayesian_prob_fits_RF},
