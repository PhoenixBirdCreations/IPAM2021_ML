...
may explain the discrepancy in the results]}  The decrease in performance for \hasrem\ between \ac{O2} and \ac{O3} of both algorithms can be attributed to \todo{\dots} The lower performance of \ac{RF} across different pipelines compared to \ac{KNN} can be explained by \todo{\dots} 
