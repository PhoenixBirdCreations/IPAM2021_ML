...
confusion matrix and its \ac{ROC} curve. For example, given a positive prediction, the \ac{LVK} defines a ``probability'' that this prediction is correct as the \ac{TPR} for the given data
