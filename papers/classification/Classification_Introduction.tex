...
to explore in depth the origin and structure of black holes, neutron stars (for a review in the properties of neutron stars emitting GWs~\cite{Lasky:2015uia}, for binaries~\cite{Baiotti:2016qnr} and as it was shown for GW170817~\cite{LIGOScientific:2018cki}), and gamma-ray bursts~\cite{Ciolfi:2018tal}; test general relativity; probe the fundamental nature of gravity; and
