...
systems with a \ac{NS} may form a
...
\footnote{The label used in alerts is {\tt HasRemnant} but we shorted it to 
...
capability to handle the statistical systematic uncertainties in the parameters
...
independent variables. In reality, the probability of the formation of tidally
