...
\tocheck{\ac{GWTC}} catalog~\tocheck{\cite{2023ApJS..267...29A}}.
...
Finally, we apply the method to derive Bayesian probabilities for the events in the \ac{LVK} \tocheck{\ac{GWTC}} catalog~\tocheck{\cite{2021SoftX..1300658A,2023ApJS..267...29A}.}  In Table~\ref{tab:real_data_bayesian} we
