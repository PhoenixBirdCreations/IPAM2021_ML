...
$D_S$ with labels assigned according to the $J$-th \ac{EOS}, and $\beta_J$ are Bayes' factors \tocheck{obtained and presented in}~\cite{Ghosh:2021eqv}. The probabilities $P_J(I|{\bf A}_{\bf X})$ in
