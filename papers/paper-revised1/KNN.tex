...
distance to the event. \tocheck{ For further details about how we fix these parameters, we refer the reader to the Appendix~\ref{app:crossval}.}This configuration differs from the \ac{LVK}'s current implementation, which employs the Mahalanobis metric and $K = 2n + 1 = 11$ neighbors, where $n$ is the number
