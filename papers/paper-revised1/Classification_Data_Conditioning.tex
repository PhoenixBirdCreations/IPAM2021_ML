...
The simulated signals are coherently injected in two-detector data from the \ac{O2} \tocheck{\ac{LVC}} observing run. The injection population is built with uniform/loguniform distribution of
