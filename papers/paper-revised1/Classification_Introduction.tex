...
day and is expected to further increase in the \ac{O5}~\cite{KAGRA:2013rdx}. Over the course of \ac{O4} and the next observing runs, \tocheck{the LVK collaborations will analyze hundreds of binary black hole (BBH) candidate detections, as well as dozens of binary neutron star (BNS) and neutron star and black hole (NSBH) merger events that could potentially be MMA sources.} Among the challenges that this new phase of \ac{GW} astronomy brings is the necessity
...
presented in Sec.~\ref{conclusions}.  \tocheck{The process of cross-validation of our algorithms is covered in depth in Appendix A. A direct comparison of our approach with the current LVK method is provided in Appendix B.}
