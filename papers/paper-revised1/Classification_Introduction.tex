...
algorithm's confusion matrix and its \ac{ROC} curve. For example, given a positive \tocheck{\sout{prediction} candidate detection}, the \ac{LVK} collaborations define a ``score'' that this 	\tocheck{\sout{prediction} candidate detection} is correct as the
