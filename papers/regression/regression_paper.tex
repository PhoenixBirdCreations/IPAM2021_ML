...
\input{Regression_Introduction.tex}

\input{Improving_Parameters.tex}
\input{GPR.tex}
\input{NNs.tex}

\input{Regression_Data_Conditioning.tex}
%\footnote{We may want to add a footnote here and there.}

\input{Regression_Results.tex}
\input{GPR_Results.tex}
\input{NN_Results.tex}
...
\input{Regression_Conclusions.tex}

\input{Regression_Acknowledgements.tex}
