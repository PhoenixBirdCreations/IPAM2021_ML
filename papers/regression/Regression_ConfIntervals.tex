...
\sa{this part is copied from old notes, to clean and write in a more decent way} 
...
ML algorithm. The requirement that $x$ must be close to $y$ can be formalized, for example, requiring that $x$ minimizes a loss 
