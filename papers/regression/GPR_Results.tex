...
\lorena{Fig~\ref{m_chi_comparisons} shows that in the case of the primary mass,
regression is able to remove some bias present in masses that are recovered to
be high. In the case of the secondary mass, high injected values tend to be
underestimated by the pipeline. Regression is able to remove some of the error
in this underesimation and more narrowly hugs the black diagonal line. 
 }
