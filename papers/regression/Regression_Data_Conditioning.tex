...
\begin{figure}
    ...
    \caption{The $m_1$-$m_2$ (left) and $\chi_1$-$\chi_2$ (right) parameter space 
		    of injections from the O2 MDC. \sa{I would change the colors, two options that I have in mind: 
		    (i) change them to be coherent with Fig.2, (ii) use three colors for BBH, BNS, BHNS}
            }
