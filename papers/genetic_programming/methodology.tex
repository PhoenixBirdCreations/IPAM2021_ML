...
\begin{figure*}[htp]
  \centering
  \subfloat[]{\includegraphics[scale=0.5]{plots/probability_plots/Probability_NS_MS1_PP.png}}\quad
  \subfloat[]{\includegraphics[scale=0.5]{plots/probability_plots/Probability_EMB_MS1_PP.png}}
...
\begin{figure*}[htp]
  \centering
  \subfloat[]{\includegraphics[scale=0.30]{plots/ROC_NS.png}}\quad
  \subfloat[]{\includegraphics[scale=0.30]{plots/ROC_EMB.png}}
